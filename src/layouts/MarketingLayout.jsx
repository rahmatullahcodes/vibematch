          ...
          <div className="flex items-center gap-3 lg:gap-5">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="min-w-0">
                ...
                <span className="mt-1 hidden text-xs text-slate-300 xl:block">Dating and social ecosystem</span>
              </span>
            </Link>

            <nav className="scrollbar-hidden hidden flex-1 gap-1 overflow-x-auto whitespace-nowrap pb-1 lg:flex lg:items-center lg:justify-center lg:pb-0">
              {siteLinks.map((link) => (
            ...
            <button
              ...
              className="ml-auto inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-3 py-2 text-xs font-semibold text-white transition hover:bg-white/20 lg:hidden"
